...
void
handle(int wait, ddjvu_context_t *ctx)
{
...
gint32
load_djvu (const gchar *filename, GimpRunMode runmode, gboolean preview)
{
    GimpPixelRgn rgn_in;
